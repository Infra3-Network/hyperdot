...
pub const POLKADOT_MAINNET: &'static str = "wss://westend-rpc.polkadot.io:443";

/// Constrant for polkadot test network endpoints
pub const POLKADOT_TESTNET: &'static str = "wss://westend-rpc.polkadot.io:443";
